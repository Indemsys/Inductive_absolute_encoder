...
/* -------------------- IDLE TASK --------------------- */
#define OS_CFG_IDLE_TASK_STK_SIZE            150u                    /* Stack size (number of CPU_STK elements)              */
                                                                    
/* ----------------- ISR HANDLER TASK ----------------- */          
#define OS_CFG_INT_Q_SIZE                    10u                    /* Size of ISR handler task queue                       */
#define OS_CFG_INT_Q_TASK_STK_SIZE           150u                   /* Stack size (number of CPU_STK elements)              */
