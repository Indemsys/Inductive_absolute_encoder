...
//NVIC_SYSPRI15   EQU     0xE000ED24                              ; System priority register (priority 15).
//NVIC_SYTICK_PRI EQU           0x20                              ; SysTick priority value (lowest).
...
OSStartHighRdy
    ...
    STRB    R1, [R0]
//    MOV32   R0, NVIC_SYSPRI15                                   ; Set the SYSTICK exception priority
//    MOV32   R1, NVIC_SYTICK_PRI
//    STRB    R1, [R0]
